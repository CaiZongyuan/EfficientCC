...
description: A meta-skill for automatically generating structured Claude Skills from technical documentation (such as Vercel AI SDK documentation). Supports user-collaborative blueprint design and analyzes documents and renders output through sub-agents. Follows progressive disclosure: first collect raw materials, then design blueprints, build and deliver the final SKILL file.
---
